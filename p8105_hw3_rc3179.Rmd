...
In the accelerometer dataset, there are a total of total of `r accel_data %>% nrow()` rows/day where each row represents a day of activities/accelerometer data. There is information on the week, day, day of the week, along with data on up to 1440 activities, for a total of `r accel_data %>% ncol()` variables, with the addition of the weekday vs weekend variable.  
